# Specification Quality Checklist: Profile Hub & Enrollment UX
...
- UX-focused feature on top of 017/018; decouples policy (tree) from enrollment routes.
- 2026-05-23: Spec upgraded from «Dialog» to **Profile Workspace** (3 layers, sidebar, no nested modals, Health, Activity, Impact Preview). See spec § UX Architecture.
