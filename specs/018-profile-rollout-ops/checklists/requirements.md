# Specification Quality Checklist: Profile Rollout & Operations
...
- Builds on completed/in-progress `017-device-control-plane`; assignment + rollout status are the net-new product capabilities.
- v1 defers staged rollout percentages and agent changes; documented in Out of Scope.
